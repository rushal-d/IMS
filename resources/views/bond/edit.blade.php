...
@section('title','Bond-Edit')
@section('content')
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form method="post" action="{{route('bond.update', $bond->id)}}">
                @csrf
                @method('PATCH')
                <div class="row">
...
{{--                                                                            @if($fiscal_year->id == $bond->fiscalyear->id) selected @endif--}}
...
{{--                                                    </div>--}}
                                                    ...
                                                    <div class="col-sm-4 my-1">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" min="0" class="form-control"
                                                                   value="{{$bond->days}}" name="days" id="days"
                                                                   placeholder="days" data-validation="required">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 my-1">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   placeholder="Mature Date (AD)"
                                                                   value="{{$bond->mature_date_en}}" readonly
                                                                   data-validation="required">
                                                            ...
                                                            <select name="institution_id" id="institution_id"
                                                                ...
                                                                @foreach($institutes as $institute)
                                                                    <option value="{{$institute->id}}"
                                                                            @if($institute->id == $bond->institute->id) selected @endif
                                                    ...
                                                    <div class="col-sm-4 my-1">
                                                        ...
                                                        <div class="input-group">
                                                            {!! Form::select('organization_branch_id', $organization_branch, $bond->organization_branch_id,['class'=>'form-control','placeholder'=>'Organization Branch', 'data-validation' => 'required']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 my-1">
                                                        <label class="" for="estimated_earning"><sup
                                                        ...
                                                        <div class="input-group">
                                                            {!! Form::select('receipt_location_id', $receipt_location, $bond->receipt_location_id,['class'=>'form-control','placeholder'=>'Receipt Location', 'data-validation' => 'required']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 my-1">
                                                        <label class="" for="estimated_earning"><sup
                                                        ...
                                                        <div class="input-group">
                                                            {!! Form::select('interest_payment_method_id', $interest_payment_method, $bond->interest_payment_method_id,['class'=>'form-control','placeholder'=>'Interest Payment Method', 'data-validation' => 'required']) !!}
                                                        </div>
                                                    </div>
{{--                                                    <div class="col-sm-4 my-1">--}}
...
{{--                                                        <div class="input-group">--}}
{{--                                                            <select name="investment_subtype_id"--}}
{{--                                                                    id="investment_subtype_id"--}}
{{--                                                                    class="form-control" data-validation="required">--}}
{{--                                                                <option value="">select</option>--}}
{{--                                                                @foreach($investment_subtypes as $investment_subtype)--}}
{{--                                                                    <option value="{{$investment_subtype->id}}"--}}
{{--                                                                            @if($investment_subtype->id == $bond->bond_type->id) selected @endif--}}
{{--                                                                    >{{$investment_subtype->name}}--}}
{{--                                                                    </option>--}}
{{--                                                                @endforeach--}}
{{--                                                            </select>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
                                                    <div class="col-sm-4 my-1">
                                                        <label class="" for="interest_rate"><sup
                                                                    class="required-field">*</sup>Interest
                                                            rate/year</label>
                                                        <div class="input-group">
                                                    ...
                                                    <div class="col-sm-4 my-1">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" step="0.01" class="form-control"
                                                                   ...
                                                                   value="{{$bond->rateperunit}}"
                                                                   data-validation="required">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 my-1">
                                                        <label class="" for="totalunit"><sup
                                                                    class="required-field">*</sup>Total
                                                            Unit</label>
                                                        <div class="input-group">
                                                            <input type="number" min="0" class="form-control"
                                                                   value="{{$bond->totalunit}}" name="totalunit"
                                                                   id="totalunit" placeholder="totalunit"
                                                                   data-validation="required">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 my-1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 my-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" min="0" class="form-control"
                                                   value="{{$bond->alert_days}}" name="alert_days"
                                                   id="alert_days" data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 my-1">
                                        ...
                                        <div class="input-group">
                                            <select name="status" id="status" class="form-control"
                                                    data-validation="required">
                                                <option value="1"
                                                        @if($bond->status == 1) selected @endif>
                                                    Active
                                                </option>
                                                <option value="2"
                                                        @if($bond->status == 2) selected @endif>
                                                    Loan
                                                </option>
                                                <option value="3"
                                                        @if($bond->status == 3) selected @endif>
                                                    Matured
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-12 my-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                   value="{{$bond->unitdetails}}" name="unitdetails"
                                                   id="unitdetails">
                                        </div>
                                    </div>
                                </div>
