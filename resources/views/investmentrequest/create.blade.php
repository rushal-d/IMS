...
@section('title','Investment Request Create')

@section('content')
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form method="post" class="" action="{{route('investment-request.store')}}">
                @csrf
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::select('institution_id',$investment_institutions,null,['class'=>'form-control','placeholder'=>'Select Bank','id'=>'institution_id']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4" for="inlineFormInputGroupUsername">Bank
                                                Branch</label>
                                            <div class="col-md-8">
                                                {!! Form::select('branch_id',$bank_branches,null,['class'=>'form-control bank_branch','placeholder'=>'Select Bank Branch','id'=>'branch_id']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::number('deposit_amount',null,['class'=>'form-control','placeholder'=>'Enter Deposit Amount','id'=>'deposit_amount','min'=>"0", 'step'=>"0.01"]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::number('days',null,['class'=>'form-control','placeholder'=>'Enter Days','id'=>'days','min'=>"0"]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4" for="inlineFormInputGroupUsername">Interest Payment
                                                Method</label>
                                            <div class="col-md-8">
                                                {!! Form::select('interest_payment_method',$investment_payment_methods,null,['class'=>'form-control','placeholder'=>'Select Interest Payment Method']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4" for="inlineFormInputGroupUsername">Organization
                                                Branch</label>
                                            <div class="col-md-8">
                                                {!! Form::select('organization_branch_id',$organization_branches,null,['class'=>'form-control','placeholder'=>'Select Organization Branch','id'=>'organization_branch']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-4" for="inlineFormInputGroupUsername">Upload Document</label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                {{Form::select('status',$investment_request_status,0,array('class'=>'form-control','id'=>'staff_id','placeholder'=>'Select Status'))}}
                                            </div>
                                        </div>
