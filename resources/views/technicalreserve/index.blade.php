                            ...
                            <div class="row">
                                <div class=" col-xl-12">
                                    <form id="maindiv" method="post"
                                          action="{{route('technicalReserve.store')}}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control nep-date" id="approved_date"
                                                       ...
                                                       value="{{ old('approved_date') }}" readonly>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                {{Form::select('fiscal_year_id',$fiscal_years, null,['class'=>'form-control','placeholder'=>'Fiscal Year'])}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                {{Form::number('amount',null,['step'=>'0.1','class'=>'form-control','placeholder'=>'Amount'])}}
                                            </div>
                                        </div>
...
@section('scripts')
    <script>
        ...
        $('.btndel').click(function (e) {
            e.preventDefault();
            var del_url = '{{ URL::to('technicalReserve') }}/' + $(this).data('id');
            console.log(del_url);
