...
@section('title','Land & Building Investment Create')
@section('content')
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form method="post" class="" action="{{route('land-building-investments.store')}}">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <i class="fa fa-align-justify"></i>
                                Land & Building Investment Create
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 my-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="date_en"
                                                   ...
                                                   value="{{old('date_en')}}" readonly data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 my-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control nep-date" id="date"
                                                   ...
                                                   value="{{old('date')}}" readonly data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 my-1">
                                        <label class="" for="date"><sup class="required-field">*</sup>Investment
                                            Type</label>
                                        <div class="input-group">
                                            {!! Form::select('type',$investment_types,old('type'),['class'=>'form-control','placeholder'=>'Select One','data-validation'=>'required']) !!}
                                        </div>
                                    </div>

                                    <div class="col-sm-4 my-1">
                                        <label class="" for="date"><sup class="required-field">*</sup>Site
                                            Location</label>
                                        <div class="input-group">
                                            {!! Form::text('site_location',old('site_location'),['class'=>'form-control','placeholder'=>'Site Location','data-validation'=>'required']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 my-1">
                                        ...
                                        <div class="input-group">
                                            {!! Form::number('amount',old('amount'),['class'=>'form-control','placeholder'=>'Amount','step'=>0.5,'data-validation'=>'required']) !!}
                                        </div>
                                    </div>
