                                ...
                                <div class="col-xl-12">
                                    ...
                                    <form id="maindiv" method="post"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                {{Form::select('organization_branch_id',$branches,$staff->organization_branch_id,array('class'=>'form-control','id'=>'branch_id','required'=>'required'))}}
                                            </div>
                                        </div>
