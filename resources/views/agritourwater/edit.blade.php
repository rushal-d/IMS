...
@section('title','Agri. Tour. Water Investment Edit')
@section('content')
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form method="post" class="" action="{{route('agri-tour-water-investments.update',$investment->id)}}">
                @method('PATCH')
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                Agri. Tour. Water Investment Edit
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 my-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="date_en"
                                                   ...
                                                   value="{{old('date_en',$investment->date_en)}}" readonly data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 my-1">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control nep-date" id="date"
                                                   ...
                                                   value="{{old('date',$investment->date)}}" readonly data-validation="required">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 my-1">
                                        <label class="" for="date"><sup class="required-field">*</sup>Investment Type</label>
                                        <div class="input-group">
                                            {!! Form::select('type',$investment_through,old('type',$investment->type),['class'=>'form-control','placeholder'=>'Select One','data-validation'=>'required']) !!}
                                        </div>
                                    </div>

                                    <div class="col-sm-4 my-1">
                                        <label class="" for="date"><sup class="required-field">*</sup>Investment Area</label>
                                        <div class="input-group">
                                            {!! Form::select('investment_area',$investment_areas,old('investment_area',$investment->investment_area),['class'=>'form-control','placeholder'=>'Select One','data-validation'=>'required']) !!}
                                        </div>
                                    </div>
