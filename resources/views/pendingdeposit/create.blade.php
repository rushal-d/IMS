...
@section('content')
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form method="post" id="deposit_form"  action="{{route('pending-deposit-store')}}">
                @csrf
                <div class="row">
...
{{--                                        <label class="" for="inlineFormInputName">Fiscal Year</label>--}}
...
{{--                                    </div>--}}
                                    ...
                                    <div class="col-sm-6 my-1">
                                        <label class="" for="inlineFormInputGroupUsername">Bank Name</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-sm-3 my-1">
                                        <label class="" for="inlineFormInputGroupUsername">Bank Branch</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-sm-3 my-1 max-20">
                                        <label class="" for="trans_date">Tranx
                                            Date (AD)</label>
                                        <div class="input-group">
                                            <input type="date" class="form-control" id="trans_date_en"
                                                   name="trans_date_en" data-validation="within_2months">
                                    ...
                                    <div class="col-sm-3 my-1 max-20">
                                        <label class="" for="mature_date">Mature Date (AD)</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-sm-3 my-1  max-20">
                                        <label class="" for="mature_date">Mature Date
                                            (BS)</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control nep-date"
                                                   id="mature_date" name="mature_date" readonly>
                                        </div>
                                    </div>

                                    <div class="col-sm-3 my-2">
                                        <label class="" for="interest_rate">Interest rate/year
                                        </label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-sm-3 my-2">
                                        <label class="" for="inlineFormInputGroupUsername">Deposit
                                            Amount</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-sm-3 my-1">
                                        <label class="" for="interest_payment_method">Interest Pay.
                                            Method</label>
                                        <div class="input-group">
                                            {!! Form::select('interest_payment_method', $interest_payment_methods, null, ['class' => 'form-control', 'placeholder' => 'All']) !!}
                                        </div>
                                    </div>

                                    <div class="col-sm-3 my-1">
                                        <label class="" for="estimated_earning">Estimated
                                            Earning</label>
                                        <div class="input-group">
                                            <input type="number" min="0" step="0.01"
                                                   class="form-control"
                                    ...
                                    <div class="col-sm-3 my-1">
                                        <label class="" for="inlineFormInputGroupUsername">Organization
                                            Branch</label>
                                        <div class="input-group">
                                            <select name="organization_branch_id" id="organization_branch"
                                                ...
                                                @foreach($organization_branches as $organization_branch)
                                                    <option value="{{$organization_branch->id}}">{{$organization_branch->branch_name ?? ''.'/'.$organization_branch->description ?? ''}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-3 my-1">
                                        <label class="" for="document_no">FD Number</label>
                                        <div class="input-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 my-1">
                                        <label class="" for="earmarked">Earmarked
                                            ?</label>
                                        <div class="input-group">
                                    ...
                                    <div class="col-sm-6 my-1">
                                        <label class="" for="alert_days">Alert
                                            Days</label>
                                        <div class="input-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @php $organization_branches_plucked = $organization_branches->pluck('branch_name', 'id') @endphp
