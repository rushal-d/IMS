...
@section('content')
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form method="post" id="deposit_form" action="{{route('deposit.update', $deposit->id)}}">
                @csrf
                @method('PATCH')
                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 my-1">
                                                ...
                                                <div class="input-group">
                                                    <select name="institution_id" id="institution_id"
                                                            ...
                                                            data-validation-error-msg="Select Bank Name">
                                            ...
                                            <div class="col-sm-3 my-1">
                                                <label class="" for="estimated_earning"><sup
                                                            class="required-field">*</sup>Interest Payment
                                                    Method</label>
                                                <div class="input-group">
                                                    {!! Form::select('interest_payment_method', $interest_payment_methods, $deposit->interest_payment_method,['class'=>'form-control','placeholder'=>'Interest Payment Method']) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3 my-1">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" min="0" step="0.01"
                                                           ...
                                                           id="estimated_earning" data-validation="required"
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if($deposit->status == 1 && $deposit->parent_id == null)
                                    <a href="{{route('deposit.placement', $deposit->id)}}"
                                       class="btn btn-sm btn-warning">@if($deposit->placement_letter != null) <i
                                                class="fas fa-check"></i> @endif Placement by bank</a>
                                    <a href="{{route('deposit.placement2', $deposit->id)}}"
                                       class="btn btn-sm btn-warning">@if($deposit->placement_letter2 != null) <i
                                                class="fas fa-check"></i> @endif Placement by cheque</a>
                                @elseif($deposit->status == 1 && $deposit->parent_id != null)
                                    <a href="{{route('deposit.renew-letter', $deposit->id)}}"
                                       class="btn btn-sm btn-warning">@if($deposit->renew_letter != null) <i
                                                class="fas fa-check"></i> @endif Renew</a>
                                @endif
                                @if($deposit->status == 3)
                                    @if($deposit->placement_letter != null)
                                        <a href="{{route('deposit.placement', $deposit->id)}}"
                                           class="btn btn-sm btn-warning"><i class="fas fa-check"></i>Placement by bank</a>
                                    @endif
                                    @if($deposit->placement_letter2 != null)
                                        <a href="{{route('deposit.placement2', $deposit->id)}}"
                                           class="btn btn-sm btn-warning"><i class="fas fa-check"></i>Placement by
                                            cheque</a>
                                    @endif
                                    @if($deposit->renew_letter != null)
                                        <a href="{{route('deposit.renew-letter')}}"
                                           class="btn btn-sm btn-warning"><i class="fas fa-check"></i>Renew</a>
                                    @else
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div style="text-align: right">
                                            <input type="hidden" name="pending" value="{{ $deposit->is_pending }}">
