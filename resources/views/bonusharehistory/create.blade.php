...
@section('title',' Bonus Share History Create')
@section('content')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <form id="maindiv" method="post" action="{{route('bonussharehistory.store')}}">
                                        @csrf
                                        ...
                                        <div class="form-group  row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="no_of_kitta"
                                                       name="no_of_kitta"
                                                       value="{{ old('no_of_kitta') }}" data-validation="required">
                                            </div>
                                        </div>
                                        <div class="form-group row">
